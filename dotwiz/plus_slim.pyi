...
def __upsert_into_dot_wiz_plus__(self: DotWizPlusSlim,
...
def __setattr_impl__(self: DotWizPlusSlim,
                     item: str,
                     value: _VT,
                     *, check_lists=True) -> None: ...

def __setitem_impl__(self: DotWizPlusSlim,
                     key: _KT,
                     value: _VT,
                     *, check_lists=True) -> None: ...
...
def __merge_impl_fn__(op: Callable[[dict, dict], dict],
                      *, check_lists=True,
                      ) -> Callable[[DotWizPlusSlim, DotWizPlusSlim | dict], DotWizPlusSlim]: ...

def __or_impl__(self: DotWizPlusSlim,
                other: DotWizPlusSlim | dict,
                *, check_lists=True,
                ) -> DotWizPlusSlim: ...

def __ror_impl__(self: DotWizPlusSlim,
                 other: DotWizPlusSlim | dict,
                 *, check_lists=True,
                 ) -> DotWizPlusSlim: ...

def __ior_impl__(self: DotWizPlusSlim,
                 other: DotWizPlusSlim | dict,
                 *, check_lists=True,
                 __update: _Update = dict.update): ...


class DotWizPlusSlim(Generic[_KT, _VT]):
    ...
    def __init__(self,
                 ...
                 *,
                 ...
                 _skip_init=False,
                 **kwargs: _T) -> None:
        """Create a new :class:`DotWizPlusSlim` instance.
    ...
    def __or__(self, other: DotWizPlusSlim | dict) -> DotWizPlusSlim: ...
    def __ior__(self, other: DotWizPlusSlim | dict) -> DotWizPlusSlim: ...
    def __ror__(self, other: DotWizPlusSlim | dict) -> DotWizPlusSlim: ...
    ...
    def from_json(cls, json_string: str = ..., *,
                       ...
                       decoder=json.loads,
                       **decoder_kwargs
                  ) -> Union[DotWizPlusSlim, list[DotWizPlusSlim]]:
        """
        De-serialize a JSON string (or file) into a :class:`DotWizPlusSlim`
        instance, or a list of :class:`DotWizPlusSlim` instances.
        ...
        :return: a `DotWizPlusSlim` instance, or a list of `DotWizPlusSlim` instances.
        """
        ...

    def to_dict(self) -> dict[_KT, _VT]:
        """
        Recursively convert the :class:`DotWizPlusSlim` instance back to a ``dict``.
        """
        ...
    ...
    def to_json(self, *,
        ...
        """
        Serialize the :class:`DotWizPlusSlim` instance as a JSON string.
    ...
    @classmethod
    def fromkeys(cls: type[DotWizPlusSlim],
                 seq: Iterable,
